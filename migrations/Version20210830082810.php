 ...
 */
final class Version20210830082810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, title VARCHAR(12) NOT NULL, e_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, title VARCHAR(12) NOT NULL, price DOUBLE PRECISION NOT NULL, e_id INT DEFAULT NULL, PRIMARY KEY(id))');
